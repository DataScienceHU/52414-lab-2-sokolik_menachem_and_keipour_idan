...
corrplot(position_corlation,order = "hclust",tl.col = "black",tl.cex = 0.8,title = "position corrlation",cex.main = 0.9)
position_corlation <- cor(fifa_players_positions[-c(1,28:30)])
...
corrplot(perform_corlation,tl.col = "black",tl.cex = 0.7,title = "performance corrlation",cex.main = 1.5, mar=c(0, 0, 1, 0), cl.ratio = 1, cl.cex=0.8)
