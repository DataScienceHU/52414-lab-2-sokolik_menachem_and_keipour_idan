...
knitr::kable(head(top_ten_Overall,10), caption = "Best Overall players.")
```
...
positions <- positions %>% filter(Preferred.Positions != "GK ")
...
We can see from the plot that most of the positions the peaks point is around 25-26 years old like RMB,RCM,LS,LB,CAM and more like this.
...
# plotting wage and potential for these young players:
ggplot(data = potential, aes(y = Value, x=Potential)) + geom_point(aes(color=Overall)) +
