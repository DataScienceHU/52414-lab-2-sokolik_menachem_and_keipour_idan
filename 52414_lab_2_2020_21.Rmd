...
# because fifa is with out NA.
nationality <- aggregate(Potential ~ Nationality, data = fifa, FUN = median)
...
mapCountryData(sPDF,nameColumnToPlot="Potential",colourPalette=colourPalette,catMethod='fixedWidth', mapTitle = "d. median of Potential by country")


```
```{r}
# # in order to color the United kingdom we'll have to median uk.
# median_UK <- median(nationality$Potential[which(nationality$Nationality=="England"|nationality$Nationality=="Wales"|nationality$Nationality=="Scotland"|nationality$Nationality=="Republic of Ireland")])
# 
# wales <- nationality$Potential[which(nationality$Nationality=="Wales")]
# ireland <-nationality$Potential[which(nationality$Nationality=="Republic of Ireland")]
# scotland <-nationality$Potential[which(nationality$Nationality=="Scotland")]
# england <- nationality$Potential[which(nationality$Nationality=="England")]
# # add a row of united kingdom with the median.
# nationality <- add_row(.data = nationality, Nationality = "United Kingdom", Potential = total_UK)
# 
...
# world_map <- mapCountryData(sPDF,nameColumnToPlot = "Potential", catMethod = "fixedWidth", colourPalette = colourPalette,
#              oceanCol = "whitesmoke", mapTitle = "Players Per Country", addLegend = T)
# 
# 
# colourPalette <- brewer.pal(7,'RdYlGn') # Choosing a color
# mapCountryData(sPDF,nameColumnToPlot="Potential",colourPalette=colourPalette,catMethod='fixedWidth', mapTitle = "d. median of Potential by country")
